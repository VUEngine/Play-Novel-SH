...
const uint32 LowPowerIndicatorBlackActorLowPowerIndicatorBlackTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 LowPowerIndicatorBlackActorLowPowerIndicatorBlackMap[] __attribute__((aligned(4))) =
{
	0x0000,0x0001,
};
