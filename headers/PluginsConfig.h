...
#define __PLUGIN_LOW_POWER_ACTOR_X_POSITION (368)
#define __PLUGIN_LOW_POWER_ACTOR_Y_POSITION (12)
...
#define __PLUGIN_SAVE_DATA_MANAGER_SAVE_STAMP "SILENTHL"
#define __PLUGIN_SAVE_DATA_MANAGER_SAVE_STAMP_LENGTH (8)

#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_USE_LOW_POWER_ENTITY (true)
...
#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_LOW_POWER_ACTOR_X_POSITION (352)
#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_LOW_POWER_ACTOR_Y_POSITION (12)
...
#define __PLUGIN_PRECAUTION_SCREEN_TEXT_FONT "Silent"
